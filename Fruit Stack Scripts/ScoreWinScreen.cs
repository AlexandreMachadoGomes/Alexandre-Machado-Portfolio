...
public class ScoreWinScreen : MonoBehaviour
{
    ...
    public GameOverFruitSpawner fruitSpawner;
    ...
    void Start()
    {
        ...
        totalScore = PlayerPrefs.GetFloat("thisRunScore");
    ...
    private void UpdateScoreNumbers()
    {
        ...
        int newScore = int.Parse(scoreText.text) + 3;
        ...
        {
            fruitSpawner.stopSpawning = true;
    ...
    private void ChangeToScoreContinued()
    {
        ...
        for (int z = 15; z < highScoreTexts.Count -1; z++)
        {
            if (scoreNumber >= userNames.Count)
            {
                Invoke("FadeInButton", 2);
